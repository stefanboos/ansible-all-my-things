...
| beads (bd) | `beads_go` | `beads_bd_version` | `beads_bd_sha256_amd64` / `beads_bd_sha256_arm64` (sha256) | version: GitHub Releases API (`gastownhall/beads`); checksum: release's `checksums.txt` |
| beads viewer (bv) | `beads_viewer` | `beads_bv_version` | `beads_bv_sha256_amd64` / `beads_bv_sha256_arm64` (sha256) | version: GitHub Releases API (`Dicklesworthstone/beads_viewer`); checksum: release's `checksums.txt` |
